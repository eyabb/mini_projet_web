...
<div class="container">
 <form id="myform" onsubmit="modifier(this.name.value,this.id.value)" >
     <input id="id" name="id" type="hidden" value="<?php echo $_GET['id']; ?>">
     <!--Classe-->
     <div class="form-group">
     <label for="name">nom Classe:</label><br>
     <input type="text" id="name" name="name" value="<?php echo $_GET['name']; ?>" class="form-control" required pattern="INFO[1-3]{1}-[A-E]{1}"
...
<script>
    ...
    event.preventDefault();
      ...
      function modifier(name,id)
      {
          console.log(name)
        var xmlhttp = new XMLHttpRequest();
        var url = "http://localhost:81/info2/modifierGP.php?id="+id+"&name="+name;
          ...
          xmlhttp.onreadystatechange=function()
              {   
                  if(this.readyState==4 && this.status==200){
                      ...
                      {
                          document.getElementById("demo").innerHTML="La modification de groupe a été bien effectué";
